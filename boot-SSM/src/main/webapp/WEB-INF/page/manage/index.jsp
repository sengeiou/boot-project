...
<head>
    ...
    <link href="/static/css/manage/font-awesome.css?v=4.4.0" rel="stylesheet">
    <link href="/static/css/manage/animate.css" rel="stylesheet">
    <link href="/static/css/manage/style.css?v=4.1.0" rel="stylesheet">
</head>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">徐</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
...
<!-- 自定义js -->
<script type="text/javascript" src="/static/js/manage/hAdmin.js?v=4.1.0"></script>
