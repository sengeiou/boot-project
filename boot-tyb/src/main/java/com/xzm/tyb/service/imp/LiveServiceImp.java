...
@Service
public class LiveServiceImp extends BaseServiceImpl<TeacherMapper, TybTeacher> implements LiveService {
//    private Log logger = LogFactory.getLog(getClass());
    @Autowired
    private HanDanPaiHangMapper handanPaiHangMapper;
    @Autowired
    private com.xzm.tyb.dao.LiveTopMapper LiveTopMapper;
    @Autowired
    private ImportantMessageMapper importantMessageMapper;
    @Autowired
    private TeacherMapper tybTeacherMapper;
    @Autowired
    private UserGenDanMapper tybUserGenDanMapper;
