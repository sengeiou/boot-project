//package com.xzm.modules.test.websocket;
//
///**
// * Created by xuzongmeng on 2017/11/28.
// */
//
...
//        Assert.notNull(user, "TestUser must not be null");
...
//        Assert.notNull(userName, "TestUser Name must not be null");
//        Assert.notNull(sessionId, "Session ID must not be null");
//        Object var3 = this.lock;
//        synchronized(this.lock) {
