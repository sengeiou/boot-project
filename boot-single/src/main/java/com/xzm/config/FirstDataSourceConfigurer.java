...
//        entityManagerFactoryRef = "entityManagerFactoryFirst",//实体管理引用
//        transactionManagerRef = "transactionManagerFirst",//失误管理引用
//        basePackages = {"com.xzm"}) //设置用户数据源所应用到的包
//public class FirstDataSourceConfigurer {
//    //注入用户数据源
//    @Autowired
...
//                .packages("com.xzm") //设置应用creditDataSource的基础包名
